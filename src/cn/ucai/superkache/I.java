...
public interface I {
	...
	String AVATAR_PATH 								= 		"F:/superwechat/superwechatDB/";
	...
	/**  下载用户头像的网络请求 */
	String DOWNLOAD_AVATAR_USER_URL				=	SuperWeChatApplication.SERVER_ROOT+"?"+
			KEY_REQUEST+"="+REQUEST_DOWNLOAD_AVATAR+"&"+AVATAR_TYPE+"=";
	/**  下载群组头像的网络请求 */
	String DOWNLOAD_AVATAR_GROUP_URL			=	SuperWeChatApplication.SERVER_ROOT+"?"+
