...
import cn.ucai.superkache.adapter.ChatHistoryAdapter;
...
public class ChatHistoryFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(cn.ucai.superkache.R.layout.fragment_conversation_history, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		errorText = (TextView) errorItem.findViewById(cn.ucai.superkache.R.id.tv_connect_errormsg);
		// contact list
		contactList = ((DemoHXSDKHelper) HXSDKHelper.getInstance()).getContactList();
		listView = (ListView) getView().findViewById(cn.ucai.superkache.R.id.list);
		adapter = new ChatHistoryAdapter(getActivity(), 1, loadUsersWithRecentChat());
		// 设置adapter
		listView.setAdapter(adapter);
		final String st = getResources().getString(cn.ucai.superkache.R.string.Cant_chat_with_yourself);
		...
		// 搜索框
		query = (EditText) getView().findViewById(cn.ucai.superkache.R.id.query);
		// 搜索框中清除button
		clearSearch = (ImageButton) getView().findViewById(cn.ucai.superkache.R.id.search_clear);
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		getActivity().getMenuInflater().inflate(cn.ucai.superkache.R.menu.delete_message, menu);
		// }
	}

	@Override
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == cn.ucai.superkache.R.id.delete_message) {
	 ...
	 */
	public void refresh() {
		adapter = new ChatHistoryAdapter(getActivity(), cn.ucai.superkache.R.layout.row_chat_history, loadUsersWithRecentChat());
		listView.setAdapter(adapter);
		adapter.notifyDataSetChanged();
	}
