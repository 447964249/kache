...
public class ShowNormalFileActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.superkache.R.layout.activity_show_file);
		progressBar = (ProgressBar) findViewById(cn.ucai.superkache.R.id.progressBar);
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                if(file != null && file.exists()&&file.isFile())
                                    file.delete();
                                String str4 = getResources().getString(cn.ucai.superkache.R.string.Failed_to_download_file);
